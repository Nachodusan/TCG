...
// --- Drag-to-scroll para expansiones ---
const expansionsContainer = document.querySelector(".expansions-container");
if (expansionsContainer) {
  let isDown = false;
  let startX;
  let scrollLeft;

  expansionsContainer.addEventListener("mousedown", (e) => {
    isDown = true;
    startX = e.pageX - expansionsContainer.offsetLeft;
    scrollLeft = expansionsContainer.scrollLeft;
  });

  expansionsContainer.addEventListener("mouseleave", () => {
    isDown = false;
  });

  expansionsContainer.addEventListener("mouseup", () => {
    isDown = false;
  });

  expansionsContainer.addEventListener("mousemove", (e) => {
    if (!isDown) return;
    e.preventDefault();
    const x = e.pageX - expansionsContainer.offsetLeft;
    const walk = x - startX;
    expansionsContainer.scrollLeft = scrollLeft - walk;
  });
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    if (localStorage.getItem("theme") === "light") {
      ...
      iconImg.src = "images/download1.svg";
    } else {
      iconImg.src = "images/download.svg";
    }
    ...
    toggleBtn.addEventListener("click", () => {
      ...
      iconImg.src = isLight ? "images/download1.svg" : "images/download.svg";
